...
mysqli_query($conn,"INSERT INTO blog(image,b_name,date,subject,blog_para1,blog_para2,blog_para3,blog_para4,main_part)
		        VALUES ('$file','$b_name','$date','$subject','$blog_para1','$blog_para2','$blog_para3','$blog_para4','$main_part')");
            ...
            <h3>Add New Blogs</h3>
              ...
              <form action="" class="form-horizontal style-form" onclick="return Filevalidation()" method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
					...
					<div class="col-md-5 ">
					  <input class="form-control-inline input-medium" type="file" name="image" id="file" required/>
            			 </div>
				 </div>
                <div class="form-group">
                  <label class="control-label col-md-1">Blog Name</label>
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="text" name="b_name" >
                  </div>
                </div>
                  <div class="form-group">
                  ...
                  <div class="col-md-5 col-xs-10">
                    <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="01-01-2021" class="input-append date dpYears">
                      <input type="text"  size="16" class="form-control" name="date" >
				...
				<div class="form-group">
                  ...
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="text" name="subject">
                  </div>
                </div>
				<div class="form-group">
                  <label class="control-label col-md-1">Blog Paragraph1</label>
                  <div class="col-md-5 ">
                    <textarea class="form-control form-control-inline input-medium"   name="blog_para1" ></textarea>
                  </div>
                </div>  
                <div class="form-group">
                  <label class="control-label col-md-1">Blog Paragraph2</label>
                  <div class="col-md-5 ">
                    <textarea class="form-control form-control-inline input-medium"   name="blog_para2" ></textarea>
                  </div>
                </div> 
                <div class="form-group">
                  <label class="control-label col-md-1">Blog Paragraph3</label>
                  <div class="col-md-5 ">
                    <textarea class="form-control form-control-inline input-medium"  name="blog_para3"></textarea>
                  </div>
                </div> 
                <div class="form-group">
                  <label class="control-label col-md-1">Blog Paragraph4</label>
                  <div class="col-md-5 ">
                    <textarea class="form-control form-control-inline input-medium"  name="blog_para4" ></textarea>
                  </div>
                </div> 
                  ...
                  <div class="col-md-5 ">
                    <textarea class="form-control form-control-inline input-medium" name="main_part" ></textarea>
                  </div>
                </div>
                   <div class="form-send ">
