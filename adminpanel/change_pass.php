    ...
    <section id="main-content">
      <section class="wrapper">
          <h3> Change Password</h3>
        	<?php 
$query = mysqli_query($conn,"select * from admin where a_id=1");
...
?>
        ...
        <label>Your Old Username</label>
          <input type="text" name="user" class="form-control" value="<?php echo $row["a_name"]; ?>" required/>
          <br>
    ...
    <!--footer start-->
      ...
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>IIAL</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
          ...
          -->
          Created by <a href="https://pnminfotech.com/">P&N Mutke Infotech</a>
        </div>
