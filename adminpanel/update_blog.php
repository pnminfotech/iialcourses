...
if(isset($_POST['update'])) {
    ...
    $blog_para1=$_POST['blog_para1'];
    $blog_para2=$_POST['blog_para2'];
    $blog_para3=$_POST['blog_para3'];
    $blog_para4=$_POST['blog_para4'];
    $main_part=$_POST['main_part'];
    
   $query= mysqli_query($conn,"update blog set b_name='$b_name',date='$date',subject='$subject',blog_para1='$blog_para1',blog_para2='$blog_para2',blog_para3='$blog_para3',blog_para4='$blog_para4',main_part='$main_part'
        where id = '".$_POST["id"]."'");
   if($query==1)
   {
       if(!empty($file))
       {
           $query1= mysqli_query($conn,"update blog set image='$file'
              where id = '".$_POST["id"]."'");
       }
...
<section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i>Update Blog Details</h3>
        <div class="row mt">
          <div class="col-lg-12">
  ...
  <?php
               $id = $_REQUEST['id'];
                              $query1 = "select id,image,b_name,date,subject,blog_para1,blog_para2,blog_para3,blog_para4,main_part from blog where id='$id'";
            ...
            <div class="form-panel">
              <form action="" class="form-horizontal style-form" onclick="return Filevalidation()" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
					<label class="control-label col-md-1">Select Image</label>
					<div class="col-md-5 ">
					  <input class="form-control-inline input-medium" type="file" name="image" id="file" />
            			 </div>
                   
				 </div>
                <div class="form-group">
                  <label class="control-label col-md-1">Blog Name</label>
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="text" name="b_name" value='<?php echo $row['2']; ?>' >
                  </div>
                </div>
                  <div class="form-group">
                  <label class="control-label col-md-1">Blog Date</label>
                  <div class="col-md-5 col-xs-10">
                    <div data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="01-01-2021" class="input-append date dpYears">
                      <input type="text" size="16" class="form-control" name="date" value='<?php echo $row['3']; ?>' required>
				...
				<div class="form-group">
                  <label class="control-label col-md-1">Blog Subject</label>
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="text" name="subject" value='<?php echo $row['4']; ?>'>
                  </div>
                </div>
				<div class="form-group">
                  <label class="control-label col-md-1">Blog Paragraph1</label>
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="text" name="blog_para1" value='<?php echo $row['5']; ?>'>
                  </div>
                </div>  
                <div class="form-group">
                  <label class="control-label col-md-1">Blog Paragraph2</label>
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="text" name="blog_para2" value='<?php echo $row['6']; ?>'>
                  </div>
                </div> 
                <div class="form-group">
                  <label class="control-label col-md-1">Blog Paragraph3</label>
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="text" name="blog_para3" value='<?php echo $row['7']; ?>'>
                  </div>
                </div> 
                <div class="form-group">
                  <label class="control-label col-md-1">Blog Paragraph4</label>
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="text" name="blog_para4" value='<?php echo $row['8']; ?>'>
                  </div>
                </div> 
                
                       <div class="form-group">
                  <label class="control-label col-md-1">Blog Main Lines</label>
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="text" name="main_part" value='<?php echo $row['9']; ?>'>
                  </div>
                </div>
                   <div class="form-send ">
