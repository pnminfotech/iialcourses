...
if(isset($_POST['update'])) {
   ...
   $query= mysqli_query($conn,"update courses set img='$file'
        where id = '".$_POST["id"]."'");

    if(mysqli_affected_rows($conn) > 0){
        echo '<script language="javascript">';
        echo 'alert("Record Updated");';
        echo 'location.href="view_courses_img.php";';
        echo '</script>';
    } else {
        echo " NOT Updated<br />";
...
<section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i>Update Courses Image</h3>
        <div class="row mt">
          <div class="col-lg-12">
            <p></p>
          </div>
  	...
  	<div class="col-lg-812 col-md-12 col-sm-12">
         ...
         <?php
               $id = $_REQUEST['id'];
               $query1 = "select id,img from courses where id='$id'";
           ...
           ?>
            ...
            <div class="form-panel">
              <form action=" "  class="form-horizontal style-form" method="post" onclick="return Filevalidation()" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label class="control-label col-md-1">Course Image</label>
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="file" name="image" id="file" value='' required>
                  </div>
                </div>   
