...
if(isset($_POST['update'])) {
   ...
   $query= mysqli_query($conn,"update courses set c_name='$c_name',msg='$msg'
        where id = '".$_POST["id"]."'");

    if(mysqli_affected_rows($conn) > 0){
        echo '<script language="javascript">';
        echo 'alert("Record Updated");';
        echo 'location.href="view_courses.php";';
        echo '</script>';
    } else {
        echo " NOT Updated<br />";
...
<section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i>Update Courses Details</h3>
        <div class="row mt">
          <div class="col-lg-12">
            <p></p>
          </div>
  	...
  	<div class="col-lg-812 col-md-12 col-sm-12">
               <?php
               $id = $_REQUEST['id'];
                              $query1 = "select id,c_name,msg from courses where id='$id'";
              ...
              <form action=" " class="form-horizontal style-form" method="post" >
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-5 ">
                    ...
                    <div class="form-group">
                  <label class="control-label col-md-1">Course Information</label>
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="text" name="msg" value='<?php echo $row['2']; ?>'>
                       <span class="help-block">Max 150 Character</span>
                  </div>
                </div>
