...
if(isset($_POST['update'])) {
   ...
   $query= mysqli_query($conn,"update faqs set que='$que',ans='$ans'
        where f_id = '".$_POST["id"]."'");

    if(mysqli_affected_rows($conn) > 0){
        echo '<script language="javascript">';
        echo 'alert("Record Updated");';
        echo 'location.href="view_faqs.php";';
        echo '</script>';
    } else {
        echo " NOT Updated<br />";
...
<section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i>Update Question And Answer</h3>
        <div class="row mt">
          <div class="col-lg-12">
            <p></p>
          </div>
     ...
     <?php
               $id = $_REQUEST['f_id'];
                              $query1 = "select * from faqs where f_id='$id'";
            ...
            <form class="contact-form " role="form" action=""  method="POST" >
              ...
              <label>Question</label>
                <input type="text" name="que" value='<?php echo $row['1']; ?>' class="form-control" placeholder=" Question" >
                <div class="validate"></div>
              </div>
              <div class="form-group">
              <label>Answer</label>
                <input type="text" name="ans" value='<?php echo $row['2']; ?>' class="form-control"  placeholder="Answer" >
                <div class="validate"></div>
              </div>
