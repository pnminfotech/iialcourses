...
if(isset($_POST['update'])) {
   ...
   $query= mysqli_query($conn,"update  syllabus_clinical_part set sub_topic='$sub_topic',main_id='$main_id'
        where id = '".$_POST["id"]."'");
...
<section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3>Update Clinical Syllabus</h3>
      ...
      <?php
               $id = $_REQUEST['id'];
                              $query1 = "select * from syllabus_clinical_part where id='$id'";
            ...
            <form class="contact-form " role="form" action=" " method="POST" >
              ...
              <label>Sub Topic</label>
                <input type="text" name="sub_topic" value='<?php echo $row['1']; ?>' class="form-control" placeholder=" " >
                <div class="validate"></div>
              </div>
              <div class="form-group">
              <label>Main Topic Id</label>
                <input type="text" name="main_id" value='<?php echo $row['2']; ?>' class="form-control" placeholder=" " >
                <div class="validate"></div>
              </div>
