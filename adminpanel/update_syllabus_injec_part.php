...
if(isset($_POST['update'])) {
   ...
   $query= mysqli_query($conn,"update  syllabus_injectables_part set sub_topic='$sub_topic',main_id='$main_id'
        where id = '".$_POST["id"]."'");
...
<section id="container">
    ...
    <section id="main-content">
      ...
      <?php
               $id = $_REQUEST['id'];
                              $query1 = "select * from syllabus_injectables_part where id='$id'";
