...
if(isset($_POST['update'])) {
   ...
   $query= mysqli_query($conn,"update syllabus_micropigmentation set topic='$topic'
        where id = '".$_POST["id"]."'");
...
<section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3>Update Micropigmentation Syllabus</h3>
        <div class="row mt">
          <div class="col-lg-12">
            <p></p>
          </div>
  	  	...
  	  	<div class="col-lg-6 col-md-6 col-sm-6">
             ...
             <?php
               $id = $_REQUEST['id'];
                              $query1 = "select * from syllabus_micropigmentation where id='$id'";
