...
if(isset($_POST['update'])) {
   ...
   $query= mysqli_query($conn,"update testimonial set name='$name',msg='$msg'
        where id = '".$_POST["id"]."'");
...
<section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i>Update Testimonial</h3>
        <div class="row mt">
          <div class="col-lg-12">
            <p></p>
          </div>
  	...
  	<div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <form class="contact-form " role="form" action=" " method="POST" >
              ...
              <div class="form-group">
              <label>Name</label>
                <input type="text" name="name" value='<?php echo $row['1']; ?>' class="form-control" placeholder=" Question" >
                <div class="validate"></div>
              </div>
              <div class="form-group">
              <label>Message</label>
                <input type="text" name="msg" value='<?php echo $row['2']; ?>' class="form-control"  placeholder="Answer" >
                <div class="validate"></div>
              </div>
