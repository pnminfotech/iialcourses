                ...
                <table class="table table-bordered table-striped table-condensed cf">
                  <thead class="cf">
                    ...
                    <th><i class="fa fa-bookmark"></i> Email</th>
                     ...
                     <th><i class="fa fa-bookmark"></i> Blog-No</th>
                  ...
                  <tbody>
     <?php
                              $query1 = "select * from blog_comment";
                     	...
                     	<td data-title="Comment"><?php echo $row['3']; ?></td>
                     	<td data-title="Date & Time"><?php echo $row['4']; ?></td>
                     	<td data-title="Blog-No"><?php echo $row['5']; ?></td>
