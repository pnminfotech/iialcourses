...
function delete_data_main(id)
{
 ...
 {
  window.location.href='del_blog.php?id='+id;
 }
}
</script> 
</head>
...
<section id="container">
    ...
    <!-- **********************************************************************************************************************************************************
              ...
              <section id="no-more-tables">
                <table class="table table-bordered table-striped table-condensed cf">
                  <thead class="cf">
                    ...
                    <th style="width:10%;"><i class="fa fa-bookmark"></i> Blog Name</th>  
              		<th><i class="fa fa-bookmark"></i> Date</th>
              		<th><i class="fa fa-bookmark"></i> Subject</th>
              		<th style="width:15%;"><i class="fa fa-bookmark"></i> Blog Para1</th>
              		<th style="width:15%;"><i class="fa fa-bookmark"></i> Blog Para2</th>              		
              		<th style="width:15%;"><i class="fa fa-bookmark"></i> Blog Para3</th>
              			<th style="width:15%;"><i class="fa fa-bookmark"></i> Blog Para4</th>
              		<th style="width:15%;"><i class="fa fa-bookmark"></i> Main Part</th>
     ...
     <?php
                     	...
                     	<td data-title="ID"><?php echo $row['0']; ?></td>
                     		<td data-title="Image " >
                        		<?php echo '<img src="data:image/jpeg;base64,'.base64_encode( $row['1']).'"  width="150" />'?>  
                        	</td> 
                     	<td data-title="Course Name"><?php echo $row['2']; ?></td>
                     	<td data-title="Date"><?php echo $row['3']; ?></td>
                     	<td data-title="Subject"><?php echo $row['4']; ?></td>
                     	<td data-title="Blog_para1"><?php echo $row['5']; ?></td>
                     	<td data-title="Blog_para2"><?php echo $row['6']; ?></td>
                     	<td data-title="Blog_para3"><?php echo $row['7']; ?></td>
                     	<td data-title="Blog_para4"><?php echo $row['8']; ?></td>
                     	<td data-title="Main_para4"><?php echo $row['9']; ?></td>
                     	
                     

	<td data-title="Action">
               
               <a href='update_blog.php?id=<?php echo $row['0']; ?>'> <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
