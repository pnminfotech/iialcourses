            ...
            <div class="content-panel">
              ...
              <section id="no-more-tables">
                <table class="table table-bordered table-striped table-condensed cf">
                  ...
                  <tbody>
                         <?php
                              $query1 = "select id,c_name,lecture,skill_level,students,certificate,Assessments,enrolled,fees,info from single_course";
                     	...
                     	<td data-title="Course Name"><?php echo $row['1']; ?></td>
                     	<td data-title="Lecture"><?php echo $row['2']; ?></td>
                     
                     	<td data-title="skill Level"><?php echo $row['3']; ?></td>
                     	<td data-title="Students"><?php echo $row['4']; ?></td>
                     	 <td data-title="Certificate"><?php echo $row['5']; ?></td>
                     	<td data-title="Assesments"><?php echo $row['6']; ?></td>
                     	<td data-title="Enrolled"><?php echo $row['7']; ?></td>
                     	<td data-title="fees"><?php echo $row['8']; ?></td>
                     	<td data-title="information"><?php echo $row['9']; ?></td>
                     
                     	

	<td data-title="Action">
               
               <a href='update_single_course.php?id=<?php echo $row['0']; ?>'> <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
