        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="content-panel">
              ...
              <section id="no-more-tables">
                <table class="table table-bordered table-striped table-condensed cf">
                  ...
                  <tbody>
                          <?php
                              $query1 = "select id,c_name,msg from courses";
	        ...
	        <td data-title="Action">
               <a href='update_courses.php?id=<?php echo $row['0']; ?>'> <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
			</td>
		</tr>
		<?php 
		$count= $count + 1; }
