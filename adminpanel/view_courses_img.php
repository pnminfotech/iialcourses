...
<section id="container">
   ...
   <section id="main-content">
            ...
            <div class="content-panel">
              ...
              <section id="no-more-tables">
                <table class="table table-bordered table-striped table-condensed cf">
                  <thead class="cf">
                    <tr>
                     <th  style="width:10%;"><i class="fa fa-bullhorn"></i>ID</th>
                  ...
                  <tbody>
                         <?php
                              $query1 = "select id,img from courses";
                     	...
                     	<td data-title="ID"><?php echo $row['0']; ?>
                     		
                     	</td>
                        	<td data-title="Image " >
                        		<?php echo '<img src="data:image/jpeg;base64,'.base64_encode( $row['img']).'"  width="150" />'?>  
                        	</td>    
	...
	<td data-title="Action">
 				...
 				<a href='update_course_image.php?id=<?php echo $row['0']; ?>'><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
			</td>
		</tr>
		<?php
	}
?>
      ...
      <!-- /wrapper -->
              ...
              <div class="panel-body">
                <h4>Notes</h4>
                <ul>
                  <li>The  file size for uploads is Must be<strong> 397 * 265 Pixel </strong>.</li>
