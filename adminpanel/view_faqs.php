    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li>
            <a class="active"  href="view_faqs.php">
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped  table-bordered table-advance table-hover">
                <h4> List of the Q &amp; A's.</h4>
                <hr>

                <thead>
                  <tr>
                    <th style="width:10%;"><center><i class="fa fa-bullhorn"></i> ID </center></th>
                    <th style="width:30%;"><center> <i class="fa fa-question-circle"></i> Question</center></th>
                    <th style="width:40%;"><center> <i class="fa fa-bookmark"></i> Answer</center></th>
                    <th style="width:20%;"><center><i class=" fa fa-edit"></i> Action</center></th>           
                  </tr>
                </thead>
                <tbody>
                     
     <?php
                              $query1 = "select * from faqs";
			...
			<td>
                     ...
                     <a href='update_faqs.php?f_id=<?php echo $row['0']; ?>'><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                    <!-- <a href='del_faqs.php?f_id=<%=rs1.getString(1)%>'><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a>-->
