...
function delete_data_main(id)
{
 ...
 {
  window.location.href='del_gallery_image.php?id='+id;
 }
}
</script>  
</head>
            ...
            <div class="content-panel">
              ...
              <section id="no-more-tables">
                <table class="table table-bordered table-striped table-condensed cf">
                  ...
                  <tbody>
  <?php
                              $query1 = "select id,image from gallery";
                     	...
                     	<td data-title="Image " >
                        		<?php echo '<img src="data:image/jpeg;base64,'.base64_encode( $row['image']).'"  width="150" />'?>  
                        	</td>
