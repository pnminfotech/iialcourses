...
function delete_data(id)
{
 ...
 {
  window.location.href='del_registration.php?id='+id;
 }
}
</script>
</head>
    ...
    <section id="main-content">
	 ...
	 <?php
                	...
                	<td data-title="ID"><?php echo $count; ?></td>
                     	...
                     	<td data-title="Gender"><?php echo $row['4']; ?></td>
                     	<td data-title="Course"><?php echo $row['5']; ?></td>
                     	<td data-title="Message"><?php echo $row['6']; ?></td>

	<td data-title="Action">
               
               <a href='reply_registration.php?id=<?php echo $row['0']; ?>'> <button class="btn btn-primary btn-xs"><i class="fa fa-comments"></i></button></a>
         
             <a href="javascript:delete_data(<?php echo $row['0']; ?>)"> <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a>
			</td>
		</tr>
		<?php
		$count = $count + 1;}
