...
mysqli_query($conn,"INSERT INTO syllabus_clinical(topic)
		        VALUES ('$topic')");
...
mysqli_query($conn,"INSERT INTO syllabus_clinical_part(main_id,sub_topic)
...
function delete_data_main(id)
{
 ...
 {
  window.location.href='del_syllabus_clinical.php?id='+id;
 }
}
</script>
...
function delete_data_part(id)
{
 if(confirm('Sure To Remove This Record ?'))
 {
  window.location.href='del_syllabus_clinical_part.php?id='+id;
 }
}
</script>
</head>
              ...
              <section id="no-more-tables">
                <table class="table table-bordered table-striped table-condensed cf">
                  ...
                  <tbody>
	                         ...
	                         <?php
                              $query1 = "select id,topic from syllabus_clinical";
                     	...
                     	<td data-title="Topic" style="color:black;font-size: 14px; font-weight: 700;"><?php echo $row['1'];?></td>    
                     		<td data-title="Action">
             				  ...
             				  <a href='update_syllabus_clinical.php?id=<?php echo $row['0'];?>'> <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                              <a href="javascript:delete_data_main(<?php echo $row['0']; ?>)"> <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a>
						</td>
						  <?php
						      $main_id=$row['0'];
                              $query21 = "select id,sub_topic from syllabus_clinical_part where main_id='$main_id';";
                                ...
                                ?>
                  				...
                  				<tr>
									...
									<td data-title="Action">
							               ...
							               <a href='update_syllabus_clinical_part.php?id=<?php echo $row21['0'];?>'> <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
        ...
        <div class="row mt">
          <div class="col-lg-12">
                  <div class="form-panel">
                   <h4>Add Clinical Course Syllabus</h4>
          ...
          <div class="col-lg-12">
                  <div class="form-panel">
                   <h4>Add clinical Course Sub-Topic Syllabus</h4>
              <form action=" " class="form-horizontal style-form" method="post">
                  <div class="form-group">
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="hidden" name="id">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="number" name="main_id" required>
                  </div>
                </div>
                <div class="form-group">
