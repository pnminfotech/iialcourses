...
mysqli_query($conn,"INSERT INTO syllabus_injectables(topic)
		        VALUES ('$topic')");
...
mysqli_query($conn,"INSERT INTO syllabus_injectables_part(main_id,sub_topic)
		        VALUES ('$main_id','$sub_topic')");
...
function delete_data_main(id)
{
 ...
 {
  window.location.href='del_syllabus_injec.php?id='+id;
 }
}
</script>

  <script type="text/javascript">
function delete_data_part(id)
{
 if(confirm('Sure To Remove This Record ?'))
 {
  window.location.href='del_syllabus_injec_part.php?id='+id;
 }
}
</script>
</head>
...
<body>
  ...
  <section id="container">
    ...
    <?php
                              $query1 = "select id,topic from syllabus_injectables";
                     	...
                     	<td data-title="Topic" style="color:black;font-size: 14px; font-weight: 700;"><?php echo $row['1'];?></td> 
                     		<td data-title="Action">
             				  ...
             				  <a href='update_syllabus_injec.php?id=<?php echo $row['0'];?>'> <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                              <a href="javascript:delete_data_main(<?php echo $row['0']; ?>)"> <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a>

						</td>
                     			 <?php
						      $main_id=$row['0'];
                              $query21 = "select id,sub_topic from syllabus_injectables_part where main_id='$main_id';";
                              ...
                              while ($row21 = mysqli_fetch_array($result21)) {
                                ...
                                ?>
                  				<tr>
					                     	...
					                     	<td><i class="fa fa-hand-o-right" style="color: #00B16A;"></i></td>
					                     	<td data-title="SubTopic"><?php echo $row21['sub_topic']; ?></td>   
                     			
									<td data-title="Action">
	               
							               <a href='update_syllabus_injec_part.php?id=<?php echo $row21['0'];?>'> <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
	                                       <a href="javascript:delete_data_part(<?php echo $row21['0']; ?>)"> <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a>
        ...
        <div class="row mt">
          <div class="col-lg-12">
                  <div class="form-panel">
                   <h4>Add Injectables Course Syllabus</h4>
              <form action="" class="form-horizontal style-form" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-5 ">
                   ...
                   <div class="form-send ">
                <button type="submit" name="addmain"  class="btn btn-large btn-primary">Submit</button>
          ...
          <div class="col-lg-12">
                  <div class="form-panel">
                   <h4>Add Injectables Course Sub-Topic Syllabus</h4>
              <form action="" class="form-horizontal style-form" method="post">
                  <div class="form-group">
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="hidden" name="id" >
                ...
                <div class="form-group">
                  <label class="control-label col-md-1">Main Topic ID:</label>
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="text" name="main_id" required >
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-md-1">Sub-Topic Name</label>
                  <div class="col-md-5 ">
                    <input class="form-control form-control-inline input-medium" size="25" type="text" name="sub_topic" required >
                  </div>
                </div>
                   <div class="form-send ">
                <button type="submit" name="addpart" class="btn btn-large btn-primary">Submit</button>
                 <button type="Reset" class="btn btn-large btn-primary">Reset</button>
            		</div>
              </form>
            </div>
