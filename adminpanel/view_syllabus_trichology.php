...
mysqli_query($conn,"INSERT INTO syllabus_trichology(topic)
		        VALUES ('$topic')");
...
function delete_data_main(id)
{
 ...
 {
  window.location.href='del_syllabus_tricho.php?id='+id;
 }
}
</script>
            ...
            <div class="content-panel">
              ...
              <section id="no-more-tables">
                <table class="table table-bordered table-striped table-condensed cf">
                  ...
                  <tbody>
                        <?php
                              $query1 = "select id,topic from syllabus_trichology";
                    	...
                    	<td data-title="ID" style="color:black;font-size: 14px;font-weight: 700;"><?php echo $row['0']; ?></td>
                     	<td data-title="Topic" style="color:black;font-size: 14px; font-weight: 700;"><?php echo $row['1'];?></td>     
                     		<td data-title="Action">
             				  ...
             				  <a href='update_syllabus_tricho.php?id=<?php echo $row['0']; ?>'> <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
        ...
        <div class="row mt">
          <div class="col-lg-12">
                  <div class="form-panel">
                   <h4>Add Trichology Course Syllabus</h4>
