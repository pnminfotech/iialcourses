        ...
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <?php
                     	...
                     	<td data-title="Message"><?php echo $row['2']; ?></td>
                     
	<td data-title="Action">
               
               <a href='update_testimonial.php?id=<?php echo $row['0']; ?>'> <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
                <a href='del_testimonial.php?id=<?php echo $row['0']; ?>'><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button></a>
