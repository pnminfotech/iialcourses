            ...
            <div class="content-panel">
              ...
              <section id="no-more-tables">
                <table class="table table-bordered table-striped table-condensed cf">
                  ...
                  <tbody>
                         <?php
                              $query1 = "select id,c_name,start_date,end_date,start_time,end_time,duration from single_course";
                     	...
                     	<td data-title="Info"><?php echo $row['2']; ?></td>
                     	<td data-title="Date"><?php echo $row['3']; ?></td>
                     	<td data-title="Strat Time"><?php echo $row['4']; ?></td>
                     	<td data-title="End Time"><?php echo $row['5']; ?></td>
                     	<td data-title="Duration"><?php echo $row['6']; ?></td>
                    
                    
	<td data-title="Action">
               
               <a href='update_timetable.php?id=<?php echo $row['0']; ?>'> <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>
