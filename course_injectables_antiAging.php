...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- Title -->
		<title>COURSE IN INJECTABLES AND ANTI-AGEING</title>
		<!-- Favicon -->
				...
				<div class="row">
					<div class="col-12">
						...
						<ul class="bread-list">
							...
							<li class="active"><a href="#">INJECTABLES AND ANTI-AGEING Course</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-12">
						<div class="single-main">
							<div class="row">
								...
								<div class="single-course">
										<div class="course-head">		
											<img src="images/course/injectable1.jpg" alt="#">
										</div>			
									</div>
									<!--/ End Single Course -->
								</div>	
										...
										<div class="feature-main">
											...
											<div class="single-feature">
												...
												<span class="label">Lectures</span>
														<?php
                                                          $query = "select c_name,start_date,end_date,start_time,end_time,lecture,duration,skill_level,students,certificate,Assessments,enrolled,fees,info from single_course where id=3";
							...
							<div class="col-12">
									...
									<div class="course-required">
										<h4>Topics Included </h4>
											<?php
                                                  $query = "select id,topic from syllabus_injectables where id<3";
                                                  $result = mysqli_query($conn, $query);
										...
										<li><span><?php echo $row21['id']; ?></span><?php echo $row21['topic']; ?></li>
													<?php
													$id=$row21['id'];
                                                  $query32 = "select sub_topic from syllabus_injectables_part where main_id=$id";
                                                  $result32 = mysqli_query($conn, $query32);
                                                  while ($row32 = mysqli_fetch_array($result32)) {
                                                    ?>		
											  	<li><i class="fa fa-hand-o-right" style="color: #00B16A;"></i><?php echo $row32['sub_topic']; ?></li>  
																	<?php 
												}
									?>
							...
							<?php
                              $query = "select id,topic from syllabus_injectables where id>2";
                              $result = mysqli_query($conn, $query);
                              while ($row = mysqli_fetch_array($result)) {
                                ?>
										<ul>
