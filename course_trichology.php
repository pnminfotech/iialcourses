...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- Title -->
		<title>COURSE IN TRICHOLOGY</title>
		<!-- Favicon -->
				...
				<div class="row">
					<div class="col-12">
						...
						<ul class="bread-list">
							...
							<li class="active"><a href="#">TRICHOLOGY Course</a></li>
						</ul>
					</div>
				</div>
			</div>
							...
							<div class="row">
								...
								<div class="single-course">
										<div class="course-head">		
											<img src="images/course/trichology1.jpg" alt="#">
										</div>			
									</div>
									<!--/ End Single Course -->
								</div>	
										...
										<div class="feature-main">
											...
											<div class="single-feature">
												...
												<span class="label">Lectures</span>
														<?php
                                                          $query = "select c_name,start_date,end_date,start_time,end_time,lecture,duration,skill_level,students,certificate,Assessments,enrolled,fees,info from single_course where id=2";
						...
						<div class="col-lg-6 col-12">
									<div class="course-required">
										<h4>Topics Included </h4>
												...
												<?php
                              $query = "select id,topic from syllabus_trichology where id<11";
                              $result = mysqli_query($conn, $query);
							...
							<?php
                              $query = "select id,topic from syllabus_trichology where id>10";
                              $result = mysqli_query($conn, $query);
                              while ($row = mysqli_fetch_array($result)) {
                                ?>
										<ul>
